		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Meliodas. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 BOT MAN 」──`,
			...
			const premium = ["558981210976@s.whatsapp.net","558981246187@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
			...
			if (messagesC.includes("peita")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/STK-20201227-WA0099.webp');
            client.sendMessage(from, tujuh, MessageType.sticker, {quoted: mek, mimetype: '.sticker/.gif', ptt:true})
	}
